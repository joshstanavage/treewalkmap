...
L.marker([41.8092822, -72.2506949], {icon: elevenIcon}).addTo(mymap).bindPopup("<div class='flex'> <div class='flex2'> <img width= '150px' src='img/cutouts/cutouts-11.png'> </div> <div class='flex1'> <h2 id='overidesmall'> Black Tupelo</h2> <h5 class='closertitle' >#5270 | Nyssa	sylvatica </h5> <p> <em>Look for: </em> Dark gray/brown with irregular ridges/alligator hide appearance, Ovate dark 3-6 inch green leaves </p> <a class='linky' href='blacktupelo.html'> <p> More on Black Tupelo  <i class='fas fa-chevron-right'></i></p> </a> </div> </div> "
...
L.marker([41.8085249, -72.2505099], {icon: twelveIcon}).addTo(mymap).bindPopup("<div class='flex'> <div class='flex2'> <img width= '150px' src='img/cutouts/cutouts-12.png'> </div> <div class='flex1'> <h2 id='overidesmall'> Panicled Goldenraintree</h2> <h5 class='closertitle' >#5520 | Koelreuteria	paniculata </h5> <p> <em>Look for: </em> Light gray/brown trunk, bipinnately compound, 6-18 inch long with 7-15 rich green leaflets, incisely lobed</p> <a class='linky' href='panicledgoldenraintree.html'> <p> More on Panicled Goldenraintree  <i class='fas fa-chevron-right'></i></p> </a> </div> </div> "
...
L.marker([41.8082966, -72.2497952], {icon: thirteenIcon}).addTo(mymap).bindPopup("<div class='flex'> <div class='flex2'> <img width= '150px' src='img/cutouts/cutouts-13.png'> </div> <div class='flex1'> <h2 id='overidesmall'> Japanese Maple cultivar</h2> <h5 class='closertitle' >#5539 | Acer	palmatum </h5> <p> <em>Look for: </em> Simple 2-5 inch long/wide with deeply 5- to 7- to 9-lobed, leaves emerge early</p> <a class='linky' href='japanesemaple.html'> <p> More on Japanese Maple cultivar  <i class='fas fa-chevron-right'></i></p> </a> </div> </div> "
